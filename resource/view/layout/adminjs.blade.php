...
<script type="text/javascript">
  ...
  var $text_sm_body_container = $('<div />', {'class': 'mb-1'}).append($text_sm_body_checkbox).append('<span>缩小字体</span>')
  ...
  var $flat_sidebar_container = $('<div />', {'class': 'mb-1'}).append($flat_sidebar_checkbox).append('<span>平铺侧边栏导航</span>')
  ...
  var $legacy_sidebar_container = $('<div />', {'class': 'mb-1'}).append($legacy_sidebar_checkbox).append('<span>侧边栏导航样式1</span>')
  ...
  var $compact_sidebar_container = $('<div />', {'class': 'mb-1'}).append($compact_sidebar_checkbox).append('<span>侧边栏导航样式2</span>')
  ...
  var $child_indent_sidebar_container = $('<div />', {'class': 'mb-1'}).append($child_indent_sidebar_checkbox).append('<span>侧边栏导航样式3</span>')
  ...
  function saveCustomizeStyle(selector, class_name, enable) {
    var styles = {
      [class_name] : enable
    }
    $.ajax({
