...
<body class="hold-transition lockscreen" @if(config('admin.lockscreen_background_image'))style="background: url({{config('admin.login_background_image')}}) no-repeat;background-size: cover;"@endif>
<!-- Automatic element centering -->
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <b>{!! config('admin.lockscreen.name') !!}</b>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <div class="lockscreen-image">
      <img src="/vendor/hyperf-admin/AdminLTE/dist/img/user1-128x128.jpg" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
